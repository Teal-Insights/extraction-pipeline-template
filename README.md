...
Schema details and field shapes: excel-grapher `user_guide/05-series-bindings.qmd` (internal direction, schema 1.13.0). Use [.agents/skills/author-bindings](.agents/skills/author-bindings/SKILL.md) for agent-assisted drafting.
