...
Structural fingerprints include literal scalar values (numbers, strings, booleans). Formulas that differ only by cell addresses or binding-key concepts can still share a cluster; formulas that differ by literal constants do not.
